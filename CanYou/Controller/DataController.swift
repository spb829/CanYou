...
//        BadgeStore.createItem(user: currentUser, name: "24hours", imageName: "badge-24hours", content: "Good start !", conditionType: .time, conditionValue: 86400)
    ...
    func initHealthInfos() {
        ...
        HealthInfoStore.createItem(name: "혈중 산소량 정상으로 상승, 일산화 탄소양이 정상으로 감소", time: 43200, content: "12시간")
        ...
        HealthInfoStore.createItem(name: "금단 현상 종료, 인슐린 저항성 정상으로 돌아옴", time: 2592000, content: "1달")
